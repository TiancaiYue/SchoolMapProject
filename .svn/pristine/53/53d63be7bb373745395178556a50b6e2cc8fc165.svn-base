package com.keyuan.schoolmap.widget.drawable;
...
public abstract class LoadingDrawable extends Drawable implements Animatable, com.keyuan.schoolmap.widget.drawable.Animatable {
