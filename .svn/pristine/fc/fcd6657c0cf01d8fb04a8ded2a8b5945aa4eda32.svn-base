package com.keyuan.schoolmap.service;
...
public class AppUpdateService extends IntentService {
    private static final String ACTION_UPDATE = "com.shichuang.entrepreneurshipplus.service.action.update";
    private static final String EXTRA_URL = "com.shichuang.entrepreneurshipplus.service.extra.url";
    private static final String EXTRA_FILE_NAME = "com.shichuang.entrepreneurshipplus.service.extra.file.name";
    private static final String DOWNLOAD_DIRECTORY = Environment.getExternalStorageDirectory().getAbsolutePath()
            + "/com.shichuang.entrepreneurshipplus/download";
    ...
    public static void startUpdate(Context context, String downloadUrl, String fileName,
        ...
        if (Build.VERSION.SDK_INT >= 24) {//判读版本是否在7.0以上
            File file = new File(context.getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS), downloadUrl);
            Uri apkUri = FileProvider.getUriForFile(context, "com.shichuang.entrepreneurshipplus.fileprovider", file);//在AndroidManifest中的android:authorities值
        ...
        try {
            ...
            if (isSuccess) {
                ...
                if (Build.VERSION.SDK_INT >= 24) {
                    ...
                    Uri apkUri = FileProvider.getUriForFile(this, "com.shichuang.entrepreneurshipplus.fileprovider", apkFile);
